                ...
                <Col md="11"  >
                    ...
                    <Form onSubmit={addProductFormSubmit}>
                        ...
                        <FormGroup>
                            ...
                            <Input id={'productQuantity'} placeholder="Enter Quantity" type={'number'} onChange={event => setProduct({ ...product, productQuantity: event.target.value })} value={product.productQuantity} ></Input>
                        </FormGroup>

                        <FormGroup>
                            <Label for={'live'}><h5><b>Product Live</b></h5></Label>
                            <Input id={'live'} className={"ms-5"} type={'checkbox'} onChange={event => setProduct({ ...product, live: !product.live })}
