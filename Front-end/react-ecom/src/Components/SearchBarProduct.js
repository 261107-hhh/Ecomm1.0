...
function SearchBarProduct({ search, par }) {
    ...
    const handelNew = (e) => {
        console.log(JSON.stringify(e) + " data got on click");
        // loadSingleProduct(res.productId)        
    }
                ...
                {par.map((res, id) => {
                    return (
                        <>
                            ...
                            {/* <a href={proLink+`${res.productId}`}> */}
                            {/* <div className='product' key={id} onClick={handelNew}> */}
                            {/* <div className='product'  key={id} > */}
                            {/* //  onClick() => {navigate(`http://localhost:3000/viewproduct/${res.productId}`)} */}

                            <a key={id} href={proLink + `${res.productId}`}>
                                {/* <a href="http://localhost:3000/viewproduct/"> */}
                                <div>
                                    {res.productName}
                                </div>

                                {/* http://localhost:3000/viewproduct/5 */}
                            </a>
                            {/* {loadSingleProduct()} */}
                            {/* </div> */}
                            {/* </div> */}
