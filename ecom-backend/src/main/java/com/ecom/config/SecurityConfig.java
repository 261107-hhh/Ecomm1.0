...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public static String[] PUBLIC_URL = { "/users/", "/auth/login", "/product/", "/products/images/11"
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeRequests().antMatchers(PUBLIC_URL).permitAll() // HttpMethod.POST,"/users/
